...
function App() {
    ...
    return (
        <div className="h-screen flex flex-col overflow-hidden bg-white dark:bg-gray-900 text-gray-900 dark:text-white">
            <header className="shrink-0 border-b border-gray-200 dark:border-gray-700 px-6 py-4 flex items-center justify-between">
                <div>
                    <h1 className="text-xl font-bold leading-tight">CV Builder</h1>
                ...
                <div className="flex items-center gap-3">
                    ...
                    <button
                        ...
                        onClick={reset}
                        title={t.headerReset}
                        className="flex items-center justify-center h-10 w-10 rounded border border-gray-300 dark:border-gray-600 text-gray-600 dark:text-gray-300 hover:border-red-400 hover:text-red-500 dark:hover:border-red-400 dark:hover:text-red-400 cursor-pointer"
                    >
                        <RotateCcw size={14} />
                    </button>
                    <PDFDownloadLink
                        ...
                        className={`flex items-center justify-center h-10 w-48 gap-2 rounded bg-gray-900 dark:bg-white text-white dark:text-gray-900 px-4 font-bold hover:bg-gray-700 dark:hover:bg-gray-200 ${lang === "fr" ? "text-xs" : "text-sm"}`}
                    >
                        {({ loading }) => (
                            <>
                                <Download size={16} />
            ...
            <div className="flex-1 grid grid-cols-1 lg:grid-cols-2 overflow-hidden">
                {/* Form */}
                <div className="h-full p-6 space-y-8 overflow-y-auto [scrollbar-gutter:stable]">
